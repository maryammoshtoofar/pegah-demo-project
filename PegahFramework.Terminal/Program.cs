...
namespace PegahFramework.Terminal;
    ...
    static int Main(string[] args)
    {
        ...
        try
        {
            ...
            using (CultureInfoUtils.ChangeCultureUI("en"))
            {
                ...
                DynamicLogic.CodeGenDirectory = @"..\..\..\..\PegahFramework.Server\CodeGen";
                ...
                Console.WriteLine("..:: Welcome to PegahFramework Loading Application ::..");
                ...
                if (args.Any())
                {
                    switch (args.First().ToLower().Trim('-', '/'))
                    {
                        ...
                        case "csharp": PegahFrameworkMigrations.CSharpMigrations(true); return 0;
                ...
                while (true)
                {
                    Action? action = new ConsoleSwitch<string, Action>
                    {
                        ...
                        {"CS", () => PegahFrameworkMigrations.CSharpMigrations(false), "C# Migrations"},
