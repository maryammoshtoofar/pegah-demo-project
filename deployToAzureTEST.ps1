...
docker build -f ".\PegahFramework.React\Dockerfile" . -t pegah-framework-test
...
$appName = 'pegah-framework-app-test'
$resourceGroup = 'pegah-framework-test'
$url = 'https://pegah-framework-app-test.azurewebsites.net/'
