...
import * as Employees from '../Employees/PegahFramework.Employees'
...
export module PegahFrameworkTypeCondition {
  export const UserEntities : Rules.TypeConditionSymbol = registerSymbol("TypeCondition", "PegahFrameworkTypeCondition.UserEntities");
  export const RoleEntities : Rules.TypeConditionSymbol = registerSymbol("TypeCondition", "PegahFrameworkTypeCondition.RoleEntities");
  export const CurrentEmployee : Rules.TypeConditionSymbol = registerSymbol("TypeCondition", "PegahFrameworkTypeCondition.CurrentEmployee");
}
