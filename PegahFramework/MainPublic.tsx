...
AppContext.setTitleFunction(pageTitle => document.title = pageTitle ? pageTitle + " - PegahFramework" : "PegahFramework");
AppContext.setTitle();
...
Services.SessionSharing.setAppNameAndRequestSessionStorage("PegahFramework");
