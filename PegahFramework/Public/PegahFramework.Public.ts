...
import * as Customers from '../Customers/PegahFramework.Customers'


export module RegisterUserMessage {
  export const PleaseFillTheFollowingFormToRegisterANewPegahFrameworkEmployee: MessageKey = new MessageKey("RegisterUserMessage", "PleaseFillTheFollowingFormToRegisterANewPegahFrameworkEmployee");
