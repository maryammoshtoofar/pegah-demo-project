...
import { RegisterUserModel, RegisterUserMessage } from './PegahFramework.Public'
  ...
  return (
    <div className="card-body">
      ...
      <p className="card-text">
        {RegisterUserMessage.PleaseFillTheFollowingFormToRegisterANewPegahFrameworkEmployee.niceToString()}
      </p>
