...
//Starts-up the engine for PegahFramework Entities, used by Web and Load Application
public static partial class Starter
{
    ...
    public static void Start(string connectionString, bool isPostgres, string? azureStorageConnectionString, string? broadcastSecret, string? broadcastUrls, WebServerBuilder? wsb, bool includeDynamic = true)
    {
        ...
        {   
            ...
            AuthLogic.Authorizer = new PegahFrameworkAuthorizer(() => Configuration.Value.ActiveDirectory);
            ...
            TypeConditionLogic.RegisterCompile<UserEntity>(PegahFrameworkTypeCondition.UserEntities, u => u.Is(UserEntity.Current));
            ...
            UserQueryLogic.RegisterUserTypeCondition(sb, PegahFrameworkTypeCondition.UserEntities);
            UserQueryLogic.RegisterRoleTypeCondition(sb, PegahFrameworkTypeCondition.RoleEntities);
            ...
            UserChartLogic.RegisterUserTypeCondition(sb, PegahFrameworkTypeCondition.UserEntities);
            UserChartLogic.RegisterRoleTypeCondition(sb, PegahFrameworkTypeCondition.RoleEntities);
            UserChartLogic.RegisterTranslatableRoutes();

            DashboardLogic.Start(sb, GetFileTypeAlgorithm(p => p.CachedQueryFolder));
            DashboardLogic.RegisterUserTypeCondition(sb, PegahFrameworkTypeCondition.UserEntities);
            DashboardLogic.RegisterRoleTypeCondition(sb, PegahFrameworkTypeCondition.RoleEntities);
            ...
            TypeConditionLogic.Register<OrderEntity>(PegahFrameworkTypeCondition.CurrentEmployee, o => o.Employee.Is(EmployeeEntity.Current));
