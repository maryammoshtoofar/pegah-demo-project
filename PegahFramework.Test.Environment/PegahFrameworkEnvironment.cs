...
public static class PegahFrameworkEnvironment
{
    ...
    public static void Start(bool includeDynamic = true)
    {
        if (!started)
        {
            var config = new ConfigurationBuilder()
                ...
                .AddUserSecrets(typeof(PegahFrameworkEnvironment).Assembly, optional: true)
                .Build();
    ...
    internal static void LoadBasics()
    {
        ...
        var localPrefix = Starter.AzureStorageConnectionString.HasText() ? "" : @"c:/PegahFrameworkFiles/";
        ...
        new ApplicationConfigurationEntity
        {
            ...
            Email = new EmailConfigurationEmbedded
            {
                SendEmails = false,
                DefaultCulture = enGB,
                UrlLeft = "http://localhost/PegahFramework",
            },
